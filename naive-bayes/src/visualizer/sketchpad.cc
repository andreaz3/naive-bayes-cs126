...
Sketchpad::Sketchpad(const vec2& top_left_corner, size_t num_pixels_per_side,
    ...
    image_shading = vector<vector<size_t>>(num_pixels_per_side, vector<size_t>(num_pixels_per_side, 0));
}
...
void Sketchpad::Clear() {
    image_shading = vector<vector<size_t>>(28, vector<size_t>(28, 0));
}
